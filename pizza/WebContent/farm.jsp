...
String queryString5 = "Insert into cart(img_path,username,pizza_id,pizza_name,price) values ('Farmhouse',?,5,'Farm House',220)";
    ...
    %>
    	<script>alert("Farm house added");window.location.href = "menu-categories.jsp";</script>
    <%}%>
