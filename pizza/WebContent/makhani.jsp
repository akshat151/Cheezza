...
String queryString5 = "Insert into cart(img_path,username,pizza_id,pizza_name,price) values ('Paneer_Makhni',?,3,'Paneer Makhani',250)";
    ...
    %>
    	<script>alert("Paneer Makhani added");window.location.href = "menu-categories.jsp";</script>
    <%}%>
