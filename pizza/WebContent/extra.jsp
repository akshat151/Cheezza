...
String queryString5 = "Insert into cart(img_path,username,pizza_id,pizza_name,price) values ('Veg_Extravaganz',?,4,'Veg Extravaganza',180)";
    ...
    %>
    	<script>alert("Veg added");window.location.href = "menu-categories.jsp";</script>
    <%}%>
