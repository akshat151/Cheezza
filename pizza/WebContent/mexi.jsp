...
String queryString5 = "Insert into cart(img_path,username,pizza_id,pizza_name,price) values ('Mexican_Green_Wave',?,6,'Mexican Green Wave',250)";
    ...
    %>
    	<script>alert("Mexican Green Wave");window.location.href = "menu-categories.jsp";</script>
    <%}%>
