...
String queryString5 = "Insert into cart(img_path,username,pizza_id,pizza_name,price) values ('margarita',?,1,'Margherita',200)";
    ...
    %>
    	<script>alert("Margherita added");window.location.href = "menu-categories.jsp";</script>
    <%}%>
